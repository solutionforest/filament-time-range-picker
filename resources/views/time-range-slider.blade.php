...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    <div wire:ignore ax-load x-ignore
        ...
        class="time-range-slider-container relative">
        <div class="relative max-w-xl w-full mt-3 mb-3">
            <div>
                ...
                <div class="relative z-10 h-1">
                    ...
                    <div class="absolute z-30 w-6 h-6 top-0 left-0 bg-white border-2 border-primary-500 rounded-full -mt-2.5 -ml-1"
                        x-bind:style="'left: ' + minthumb + '%'"></div>

                    <div class="absolute z-30 w-6 h-6 top-0 right-0 bg-white border-2 border-primary-500 rounded-full -mt-2.5 -mr-3"
        ...
        @if ($ifDisableInput())
            <div class="pt-2 grid grid-cols-2 gap-3 date-label-container w-full">
            ...
            <div class="pt-2 grid grid-cols-2 gap-3">
                <div class="flex items-center justify-center rtl:flex-row-reverse">
                    <x-filament::input.wrapper
                        ...
                        <div class="flex px-1 py-2.5">
                            <input max="23" min="0" type="number" inputmode="numeric" x-model="minhour"
                                x-on:change="inputtrigger"
                ...
                <div class="flex items-center justify-center rtl:flex-row-reverse">
                    <x-filament::input.wrapper
                        ...
                        :attributes="\Filament\Support\prepare_inherited_attributes($getExtraAttributeBag())">
                        <div class="flex px-1 py-2.5">
                            <input max="23" min="0" type="number" inputmode="numeric" x-model="maxhour"
                                x-on:change="inputtrigger"
                                class="time-component text-center !appearance-none w-10 border-none bg-transparent p-0 text-center text-sm text-gray-950 focus:ring-0 dark:text-white" />
